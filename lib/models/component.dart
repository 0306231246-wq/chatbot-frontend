...
class PcComponent {
  ...
  factory PcComponent.fromJson(Map<String, dynamic> json) {
    ...
    final vramGb = rawVram != null ? double.tryParse(rawVram.toString()) : null;
    ...
    return PcComponent(
      ...
      totalCores: int.tryParse(
          (json['số lõi'] ?? json['total_cores'] ?? '').toString()),
  ...
  static String _extractManufacturer(String name) {
    ...
    if (n.contains('AMD') ||
        ...
        n.contains('RADEON') ||
        n.contains('EPYC') ||
        n.contains('THREADRIPPER')) return 'AMD';
    if (n.contains('INTEL') ||
        n.contains('CORE I') ||
        n.contains('XEON') ||
        n.contains('PENTIUM') ||
        n.contains('CELERON') ||
        n.contains('ARC')) return 'Intel';
    if (n.contains('NVIDIA') ||
        n.contains('GEFORCE') ||
        n.contains('RTX') ||
        n.contains('GTX') ||
        n.contains('GT ')) return 'NVIDIA';
    if (n.startsWith('ASUS') || n.startsWith('ROG') || n.startsWith('TUF'))
      return 'ASUS';
